...
export const initPromoSlider = () => {
    const _sliderPromos = document.querySelector('.slider-promos');
    const _sliderControls = document.querySelector('.promos__controls');
    const _prevItem = _sliderControls.querySelector('.slider-promos__button_prev');
    const _nextItem = _sliderControls.querySelector('.slider-promos__button_next');
    const _pageDots = _sliderControls.querySelector('.page-dots');

    const dotsArray = [];
    let activeDot = null;

    const promoSlider = new Flickity(_sliderPromos, {
        cellAlign: 'center',
